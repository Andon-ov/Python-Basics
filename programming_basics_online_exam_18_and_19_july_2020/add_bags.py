...
if kg_of_luggage < 10:
    price_of_luggage = price_luggage_over_20_kg * 0.2
elif 10 <= kg_of_luggage <= 20:
    price_of_luggage = price_luggage_over_20_kg * 0.5
elif kg_of_luggage > 20:
     price_of_luggage = price_luggage_over_20_kg

if days_to_travel > 30:
    price_of_luggage *= 1.1
elif 7 <= days_to_travel <= 30:
    price_of_luggage *= 1.15
elif days_to_travel < 7:
    price_of_luggage *= 1.40
price_of_luggage *= number_of_luggage
print(f'The total price of bags is: {price_of_luggage:.2f} lv. ')