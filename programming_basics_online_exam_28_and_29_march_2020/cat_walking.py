...
calories_total = (minutes_walk * number_of_walks) * 5
if calories_total >= calories_per_day / 2:
    print(f"Yes, the walk for your cat is enough. Burned calories per day: {calories_total}.")
else:
    print(f"No, the walk for your cat is not enough. Burned calories per day: {calories_total}.")