...
# което трябва да изкачи и времето в секунди, за което той изкачва 1 метър. Да се напише програма,
...
try_new_record = ((distance_in_meters * time_in_seconds_for_1m) + delay)
total = abs(try_new_record - record_in_seconds)
if record_in_seconds <= try_new_record:
    print(f'No! He was {total:.2f} seconds slower.')
elif record_in_seconds > try_new_record:
    print(f'Yes! The new record is {try_new_record:.2f} seconds.')
